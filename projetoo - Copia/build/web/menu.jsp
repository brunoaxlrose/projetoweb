            ...
            <div id="content">
                    ...
                    <div class="xd-topbar">
                        ...
                        <div class="xp-breadcrumbbar text-center">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-curent="page">Home</li>
                            </ol>
                        </div>				 		 
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-3">
                            <div class="item gray-background">
                                <a id="vendas" href="#" >VENDAS &#128178</a>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="item gray-background">
                                <a id="pessoas" href="#">PESSOAS &#128101</a>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="item gray-background">
                                <a id="caixa" href="#">CAIXA &#128181</a>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="item gray-background">
                                <a id="menufiscal" href="#">MENU FISCAL &#128203</a>
                            </div>
                        </div>
                    </div>
                    <br>
                    <div class="row">
                        <div class="col-md-3">
                            <div class="item gray-background">
                                <a id="produto" href="#">PRODUTO &#128230</a>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="item gray-background">
                                <a id="usuario" href="#">USUÁRIO &#128100</a>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="item gray-background">
                                <a id="relatorio" href="#">RELATÓRIO &#128196</a>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="item gray-background">
                                <a id="controlediario" href="#">CONTROLE DIÁRIO &#128216</a>
                            </div>
                        </div>
                    </div>             
                </div>
