<%-- 
    ...
    Created on : 15 de set. de 2023, 13:25:30
    ...
    <body>
        <div class="wrapper">
            ...
            <div id="content">
                    ...
                    <div class="xd-topbar">
                        ...
                        <div class="xp-breadcrumbbar text-center">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-curent="page">CADASTRO CLIENTE</li>
                            </ol>
                        </div>				 		 
                    </div>
                </div>
                ...
                <div class="container ">
                    <form name="frmCadCliente" action="processar_cadastro_cliente.jsp" method="post">
                        <!-- Campo Nome -->
                        <div class="row">
                            <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control" name="rg" id="rg" placeholder="XX.XXX.XXX-X" required>
                            </div>
