<%-- 
    Document   : consulta_cliente_nome
    Created on : 26 de out. de 2023, 08:13:40
        ...
        <div class="wrapper">
            ...
            <div id="sidebar">
                ...
                <ul class="list-unstyled component m-0">
                    ...
                    <li class="">
                        <a href="../index.html" id="sair-link" class=""><i class="material-icons">exit_to_app</i>Sair </a>
                    </li>
            ...
            <div id="content">
                ...
                <br>
                <div class="container ">
                    <form name="frmConsCliente" action="cliente_consulta_cpf.jsp" method="post">
                        <div class="mb-3">
                            <label for="cpf" class="form-label">CPF:</label>
                            <input type="text" class="form-control" name="cpf">
                        </div>
                        <div class="text-center">
                            <button type="reset" class="btn btn-primary custom-button">Limpar</button>
                            <button type="submit" class="btn btn-primary custom-button">Consultar</button>
                            <a href="../menu.jsp" class="btn btn-primary custom-button">Voltar</a>
                        </div>
                    </form>
                </div>
