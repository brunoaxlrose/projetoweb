<%-- 
    Document   : cliente_consulta_nome
    Created on : 26 de out. de 2023, 08:22:23
            ...
            <div id="content">
                ...
                <div class="top-navbar">
                    <div class="xd-topbar">
                        ...
                        <div class="xp-breadcrumbbar text-center">
                            <h4 class="page-title">Consulta Cliente [CPF]</h4>
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="#">JBM</a></li>
                                <li class="breadcrumb-item active" aria-curent="page">CONSULTA CLIENTE [CPF]</li>
                            </ol>
                        </div>				 		 
                    </div>
                </div>
                ...
                <div class="container ">
                    ...
                    <%
                        ...
                        // Consultar cliente
                        Cliente resultado = clienteDao.consultarCpf(cliente);
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                <td> 
                                    <a href="../alterar/processar_alteracao_cliente.jsp?cpf=<%= cliente.getCpf()%> "> <span class="material-icons">update</span> </a>
                                    <a href="../alterar/processar_alteracao_cliente.jsp?cpf=<%= cliente.getCpf()%> "> <span class="material-icons">delete</span> </a>
                                </td> 
                                <td><%= resultado.getNome()%></td>
                                <td><%= resultado.getRg()%></td>
                                <td><%= resultado.getCpf()%></td>
                                <td><%= resultado.getEmail()%></td>
                                <td><%= resultado.getTelefone()%></td>
                                <td><%= resultado.getCelular()%></td>
                                <td><%= resultado.getEnderecoCep()%></td>
                                <td><%= resultado.getEnderecoRua()%></td>
                                <td><%= resultado.getEnderecoNumero()%></td>
                                <td><%= resultado.getEnderecoComplemento()%></td>
                                <td><%= resultado.getEnderecoBairro()%></td>
                                <td><%= resultado.getEnderecoCidade()%></td>
                                <td><%= resultado.getEnderecoUf()%></td>
                            </tr>
                        </table>
                    </div>
                    <% } else { %>
                    <p>Nenhum cliente encontrado com o CPF informado.</p>
                    <% }%>
